        ...
        <main class="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-8 px-6 py-8">
            <nav class="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-200 pb-5">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <a href="{{ route('admin.kyc.index') }}" class="rounded-md border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-700 hover:border-zinc-400">Queue</a>
            ...
            <section class="space-y-4 rounded-lg border border-zinc-200 bg-white p-5 text-sm">
                ...
                <section class="rounded-lg border border-zinc-200 bg-white p-5">
                    ...
                    <form method="POST" action="{{ route('admin.kyc.decide', $kyc) }}" class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="review_notes" name="review_notes" rows="3" class="mt-2 w-full rounded-md border border-zinc-300 bg-zinc-50 px-3 py-2 text-sm text-black outline-none focus:border-emerald-400">{{ old('review_notes') }}</textarea>
                        </div>
                        <div class="flex flex-wrap gap-3">
                            <button type="submit" name="decision" value="approve" class="rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-black hover:bg-emerald-500">Approve</button>
